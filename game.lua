...
function game_init(level_index)
  local state = {
    LEVELS = {
      {mushrooms=2, roses=3, start_pos={5,5}, vines=0, river={river_start={0,64},river_end={128,64}, bridge={64,72}}},
      {mushrooms=0, roses=3, start_pos={5,5}, vines=4, river={river_start={0,64},river_end={128,64}, bridge={64,72}}},
